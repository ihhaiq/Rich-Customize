...
(() => {
  ...
  const TERM_ROWS = {
    es:["Botón","Editar","Añadir","Elegir","Enlace","Copiar","Buscar","Vista previa","Ajustes","Error","Escribir","Ubicación","Fila","Columna","Celda","Selección","Subir","Abrir","Cerrar","Combinar","Alineación"],
    fr:["Bouton","Modifier","Ajouter","Choisir","Lien","Copier","Rechercher","Aperçu","Paramètres","Erreur","Écrire","Emplacement","Ligne","Colonne","Cellule","Sélection","Téléverser","Ouvrir","Fermer","Fusionner","Alignement"],
    de:["Schaltfläche","Bearbeiten","Hinzufügen","Auswählen","Link","Kopieren","Suchen","Vorschau","Einstellungen","Fehler","Schreiben","Standort","Zeile","Spalte","Zelle","Auswahl","Hochladen","Öffnen","Schließen","Zusammenführen","Ausrichtung"],
    it:["Pulsante","Modifica","Aggiungi","Scegli","Link","Copia","Cerca","Anteprima","Impostazioni","Errore","Scrivi","Posizione","Riga","Colonna","Cella","Selezione","Carica","Apri","Chiudi","Unisci","Allineamento"],
    pt:["Botão","Editar","Adicionar","Escolher","Link","Copiar","Pesquisar","Prévia","Configurações","Erro","Escrever","Localização","Linha","Coluna","Célula","Seleção","Carregar","Abrir","Fechar","Mesclar","Alinhamento"],
    nl:["Knop","Bewerken","Toevoegen","Kiezen","Link","Kopiëren","Zoeken","Voorbeeld","Instellingen","Fout","Schrijven","Locatie","Rij","Kolom","Cel","Selectie","Uploaden","Openen","Sluiten","Samenvoegen","Uitlijning"],
    pl:["Przycisk","Edytuj","Dodaj","Wybierz","Link","Kopiuj","Szukaj","Podgląd","Ustawienia","Błąd","Pisz","Lokalizacja","Wiersz","Kolumna","Komórka","Wybór","Prześlij","Otwórz","Zamknij","Scal","Wyrównanie"],
    uk:["Кнопка","Редагувати","Додати","Вибрати","Посилання","Копіювати","Пошук","Перегляд","Налаштування","Помилка","Написати","Розташування","Рядок","Стовпець","Комірка","Вибір","Завантажити","Відкрити","Закрити","Об’єднати","Вирівнювання"],
    tr:["Düğme","Düzenle","Ekle","Seç","Bağlantı","Kopyala","Ara","Önizleme","Ayarlar","Hata","Yaz","Konum","Satır","Sütun","Hücre","Seçim","Yükle","Aç","Kapat","Birleştir","Hizalama"],
    fa:["دکمه","ویرایش","افزودن","انتخاب","پیوند","کپی","جستجو","پیش‌نمایش","تنظیمات","خطا","نوشتن","موقعیت","ردیف","ستون","سلول","انتخاب","بارگذاری","باز کردن","بستن","ادغام","تراز"],
    ku:["Bişkok","Sererast bike","Zêde bike","Hilbijêre","Girêdan","Kopî bike","Lêgerîn","Pêşdîtin","Mîheng","Çewtî","Binivîse","Cih","Rêz","Stûn","Xanê","Hilbijartin","Barkirin","Veke","Bigire","Yek bike","Rêzkirin"],
    ur:["بٹن","ترمیم","شامل کریں","منتخب کریں","لنک","نقل کریں","تلاش","پیش منظر","ترتیبات","خرابی","لکھیں","مقام","قطار","کالم","خانہ","انتخاب","اپ لوڈ","کھولیں","بند کریں","ضم کریں","سیدھ"],
    hi:["बटन","संपादित करें","जोड़ें","चुनें","लिंक","कॉपी करें","खोजें","पूर्वावलोकन","सेटिंग्स","त्रुटि","लिखें","स्थान","पंक्ति","स्तंभ","सेल","चयन","अपलोड","खोलें","बंद करें","मर्ज करें","संरेखण"],
    id:["Tombol","Edit","Tambah","Pilih","Tautan","Salin","Cari","Pratinjau","Pengaturan","Kesalahan","Tulis","Lokasi","Baris","Kolom","Sel","Pilihan","Unggah","Buka","Tutup","Gabungkan","Perataan"],
    ja:["ボタン","編集","追加","選択","リンク","コピー","検索","プレビュー","設定","エラー","入力","位置","行","列","セル","選択","アップロード","開く","閉じる","結合","配置"],
    ko:["버튼","편집","추가","선택","링크","복사","검색","미리보기","설정","오류","작성","위치","행","열","셀","선택","업로드","열기","닫기","병합","정렬"],
    vi:["Nút","Chỉnh sửa","Thêm","Chọn","Liên kết","Sao chép","Tìm kiếm","Xem trước","Cài đặt","Lỗi","Viết","Vị trí","Hàng","Cột","Ô","Lựa chọn","Tải lên","Mở","Đóng","Gộp","Căn chỉnh"],
    th:["ปุ่ม","แก้ไข","เพิ่ม","เลือก","ลิงก์","คัดลอก","ค้นหา","ดูตัวอย่าง","การตั้งค่า","ข้อผิดพลาด","เขียน","ตำแหน่ง","แถว","คอลัมน์","เซลล์","การเลือก","อัปโหลด","เปิด","ปิด","รวม","การจัดแนว"],
    "zh-hans":["按钮","编辑","添加","选择","链接","复制","搜索","预览","设置","错误","输入","位置","行","列","单元格","选择","上传","打开","关闭","合并","对齐"],
    "zh-hant":["按鈕","編輯","新增","選擇","連結","複製","搜尋","預覽","設定","錯誤","輸入","位置","列","欄","儲存格","選擇","上傳","開啟","關閉","合併","對齊"],
  };
  ...
  function subjectFor(key) {
    ...
    if (key.startsWith("media.")) return originalT("top.media");
    if (key.startsWith("inline.")) return originalT("top.text");
