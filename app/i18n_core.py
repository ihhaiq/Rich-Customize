...
EN: dict[str, str] = {
    ...
    "ابنِ محتوى «تفاصيل».": "Build the content inside Details.",
    "عدد البلوكات الداخلية: ": "Inner block count: ",
    "أرسل نصًا أو وسائط مباشرة للإنهاء، أو أضف بلوكات داخلية.": "Send text or media to finish directly, or add inner blocks.",
    "➕ بلوك داخلي": "➕ Inner Block",
    "✅ إنهاء التفاصيل (": "✅ Finish Details (",
    "🔙 أنواع البلوكات الداخلية": "🔙 Inner Block Types",
    "انتهت عملية إضافة التفاصيل.": "The Details add flow has expired.",
    "اختر نوع البلوك الداخلي المتوافق مع «تفاصيل»:": "Choose an inner block type compatible with Details:",
    "أضف بلوكًا داخليًا واحدًا على الأقل.": "Add at least one inner block.",
    "تمت إضافة التفاصيل": "Details added.",
    "تم إلغاء إضافة التفاصيل": "Details add cancelled.",
    "نوع بلوك داخلي غير صالح.": "Invalid inner block type.",
    "تمت إضافة البلوك الداخلي.": "Inner block added.",
    "انتهت عملية إضافة البلوك الداخلي.": "The inner-block add flow has expired.",
    "نوع المحتوى غير صحيح للبلوك الداخلي المحدد.": "Wrong content type for the selected inner block.",
    ...
    "إدارة أزرار الرسالة الغنية": "Manage rich-message buttons",
    ...
    "أرسل رابط تسجيل الدخول ويجب أن يبدأ بـ https://": "Send a login URL beginning with https://.",
    "هذا النوع يحتاج إلى رابط HTTPS صالح.": "This type requires a valid HTTPS URL.",
    "استعلام Inline طويل جدًا؛ الحد الأقصى 256 حرفًا.": "The inline query is too long; maximum 256 characters.",
    ...
    "🎛 إعدادات خلايا الجدول": "🎛 Table Cell Settings",
    "🧱 إعدادات مظهر الجدول": "🧱 Table Appearance Settings",
    "• الحدود — إظهار أو إخفاء الخطوط المحيطة بالجدول وبين الخلايا.": "• Borders — show or hide lines around the table and between cells.",
    "• صفوف مخططة — تمييز الصفوف بالتناوب لتسهيل قراءة الجدول.": "• Striped rows — alternate row styling to make the table easier to read.",
    "• وضع مضغوط — تقليل المسافات داخل الخلايا ليظهر الجدول بحجم أصغر وأكثر كثافة.": "• Compact mode — reduce cell spacing for a smaller, denser table.",
    "• عنوان الجدول — إضافة نص وصفي يظهر كعنوان للجدول أو تعديل العنوان الحالي.": "• Table caption — add or edit descriptive text displayed with the table.",
    "✅ = مفعّل   |   ❌ = غير مفعّل": "✅ = enabled   |   ❌ = disabled",
    "✏️ تعديل عنوان الجدول": "✏️ Edit Table Caption",
    "✏️ إضافة عنوان للجدول": "✏️ Add Table Caption",
    "صفوف مخططة": "Striped Rows",
    "وضع مضغوط": "Compact Mode",
    "الحدود": "Borders",
    "🔗 دمج مع الخلية التالية": "🔗 Merge with Next Cell",
    "↔️ دمج حتى نهاية الصف": "↔️ Merge to Row End",
    "✂️ فك دمج خلية": "✂️ Unmerge Cell",
    "🟨 تظليل خلية": "🟨 Shade Cell", "⬜ إلغاء تظليل خلية": "⬜ Unshade Cell",
    "↔️ توسيط خلية": "↔️ Center Cell", "↩️ إلغاء توسيط خلية": "↩️ Uncenter Cell",
    "🟨 تظليل الجميع": "🟨 Shade All", "⬜ إلغاء تظليل الجميع": "⬜ Unshade All",
    "↔️ توسيط الجميع": "↔️ Center All", "↩️ إلغاء توسيط الجميع": "↩️ Uncenter All",
    "إعدادات خلايا الجدول": "Table cell settings",
    "اختر العملية التي تريد تطبيقها:": "Choose the operation to apply:",
    "هذا الجدول لم يعد موجودًا أو لا يحتوي خلايا.": "This table no longer exists or has no cells.",
    "هذا الجدول لم يعد موجودًا.": "This table no longer exists.",
    "تعذر تعديل الجدول.": "Couldn't edit the table.",
    "تم تفعيل": "Enabled",
    "تم إلغاء": "Disabled",
    "أرسل عنوان الجدول. لإزالة العنوان أرسل /empty": "Send the table caption. To remove it, send /empty.",
    "أرسل عنوانًا صحيحًا أو /empty لإزالته.": "Send a valid caption, or /empty to remove it.",
    "تعذر تعديل خلايا الجدول.": "Couldn't edit the table cells.",
    "اختر الخلية المطلوبة\n\nالرقم الأول للصف، والثاني للعمود:": "Choose a cell.\n\nThe first number is the row and the second is the column:",
    "اختر الخلية التي تريد دمجها مع الخلية التالية:": "Choose the cell to merge with the next cell:",
    "اختر الخلية؛ ستندمج مع جميع الخلايا التالية في الصف:": "Choose a cell; it will merge with every following cell in the row:",
    "اختر الخلية المدمجة التي تريد فكها:": "Choose the merged cell to unmerge:",
    "اختيار خلية غير صالح.": "Invalid cell selection.",
    "هذا الجدول أو الإجراء لم يعد موجودًا.": "This table or action no longer exists.",
    "تم دمج الخليتين": "The two cells were merged.",
    "لا توجد خلية تالية قابلة للدمج.": "There is no compatible next cell to merge.",
    "تم دمج الخلايا حتى نهاية الصف": "Cells were merged to the end of the row.",
    "لا توجد خلايا تالية قابلة للدمج.": "There are no compatible following cells to merge.",
    "تم فك دمج الخلية": "The cell was unmerged.",
    "هذه الخلية غير مدمجة.": "This cell isn't merged.",
    "هذه الخلية لم تعد موجودة.": "This cell no longer exists.",
    "تم تظليل الخلية": "Cell shaded.", "تم إلغاء تظليل الخلية": "Cell unshaded.",
    "تم توسيط نص الخلية": "Cell text centered.", "تم إلغاء توسيط نص الخلية": "Cell text uncentered.",
    "تم تظليل جميع الخلايا": "All cells shaded.", "تم إلغاء تظليل جميع الخلايا": "All cells unshaded.",
    "تم توسيط نص جميع الخلايا": "All cell text centered.", "تم إلغاء توسيط نص جميع الخلايا": "All cell text uncentered.",
