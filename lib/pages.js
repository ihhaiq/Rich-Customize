...
export function pagesCopy(languageCode) {
  ...
  return {
    title: t(locale, 'pages.saved_title'),
    prompt: t(locale, 'pages.open_prompt'),
    empty: t(locale, 'pages.empty'),
    sortTitle: t(locale, 'pages.sort_title'),
    copyCode: t(locale, 'pages.copy_code'),
    search: t(locale, 'pages.search_button'),
    sort: t(locale, 'pages.sort_button'),
    back: t(locale, 'ux.common.back'),
    searchResults: (query) => t(locale, 'pages.search_results', { query }),
    searchNone: (query) => t(locale, 'pages.search_none', { query }),
    searchPrompt: t(locale, 'pages.search_prompt'),
    searchInvalid: t(locale, 'pages.search_invalid'),
    sortText: t(locale, 'pages.sort_text'),
    sortUpdated: t(locale, 'pages.sort_updated'),
    sortNewest: t(locale, 'pages.sort_newest'),
    sortOldest: t(locale, 'pages.sort_oldest'),
    sortByTitle: t(locale, 'pages.sort_title'),
    sortDone: t(locale, 'pages.sort_done'),
    deleteYes: t(locale, 'pages.delete_yes'),
    cancel: t(locale, 'common.cancel'),
    restore: t(locale, 'ux.pages.restore'),
  };
}
...
export function buildPageDeleteConfirmationKeyboard(pageId, pageIndex, languageCode) {
  return {
    inline_keyboard: [[
      {
        text: pagesCopy(languageCode).deleteYes,
        callback_data: 'r:pdeleteok:' + pageId + ':' + pageIndex,
        style: 'danger',
      },
      {
        text: pagesCopy(languageCode).cancel,
...
export function buildPageRestoreKeyboard(pageIndex, languageCode) {
  return {
    inline_keyboard: [
      [{
        text: pagesCopy(languageCode).restore,
