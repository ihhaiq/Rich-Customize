...
export async function handleEditorButtonCallback(query) {
  ...
  if(data.startsWith('r:bs:')){
    ...
    const labels=ar(languageCode)?{
      delete:'اختر الزر الذي تريد إزالته:',style:'اختر الزر الذي تريد تغيير لونه:',
      move:'اختر الزر الذي تريد تغيير ترتيبه:',value:'اختر الزر الذي تريد تغيير محتواه:',
      url:'اختر الزر الذي تريد تغيير محتواه:',title:'اختر الزر الذي تريد تغيير عنوانه:',
      type:'اختر الزر الذي تريد تغيير نوعه:',
    }:{
      delete:'Choose the button to remove:',style:'Choose the button whose color you want to change:',
      move:'Choose the button to reorder:',value:'Choose the button whose value you want to change:',
      url:'Choose the button whose value you want to change:',title:'Choose the button whose title you want to change:',
      type:'Choose the button whose type you want to change:',
    };
  ...
  if(data.startsWith('r:bt:')){
    ...
    if(action==='delete'){
      await edit(query,(ar(languageCode)?'هل تريد حذف الزر «':'Delete button “')+String(button.text||'Button')+(ar(languageCode)?'»؟':'”?'),deleteKeyboard(id,languageCode));
