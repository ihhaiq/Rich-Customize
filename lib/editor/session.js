...
export const STATE = {
  ...
  SELECTING_BUTTON_USER: 'RichEditorStates:selecting_button_user',
  ...
  EDITING_BLOCK: 'RichEditorStates:editing_block',
  ADDING_BLOCK: 'RichEditorStates:adding_block',
  EDITING_BUTTON: 'RichEditorStates:editing_button',
  EDITING_TABLE_CAPTION: 'RichEditorStates:editing_table_caption',
  DEV_WAITING_IMPORT: 'DeveloperStates:waiting_import',
  DEV_CONFIRMING_IMPORT: 'DeveloperStates:confirming_import',
};
